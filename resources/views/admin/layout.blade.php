...
@if(Auth::user()->active==1)
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets" style="height:430px;">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="{{asset('public/admin/assets/images/users/1.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('public/admin/assets/images/users/4.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('public/admin/assets/images/users/5.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="{{asset('public/admin/assets/images/users/2.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
    ...
    <div class="card-header"><div class="container text-muted">
        Chào mừng bạn đến trang quản trị hệ thống website ngày mới 24h
    </div>
    </div>
    @endif
@endif
