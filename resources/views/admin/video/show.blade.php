...
<div class="container-fluid shadow-sm p-3 bg-white rounded">
    <div class="row">
        <div class="col-md-12 text-right"><a href="{{route('admin.video.index')}}" alt="close"><i class="fas fa-times-circle "></i></a>
        </div>
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.video.update', ['id' => $video->id]) }}" method="POST">
                        ...
                        <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="input1" name="image" value="{{ $video->image }}" placeholder="| Browser" readonly>
