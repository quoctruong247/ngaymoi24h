	...
	<div class="row mt-1">
		<div class="col-md-9">
            ...
            <?php 
             ...
             ?>
            <?php if(count($categories_more)>0): ?>
        	...
        	<div class="row mt-1" style="background: #d4dadd;">
               <?php $__currentLoopData = $categories_more; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
		...
		<div class="col-md-3">
			<?php echo $__env->make('default.layouts.right', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</div><!-- col-md-3 -->
	</div>
</div>

<?php $__env->stopSection(); ?><!-- end section pc -->
<?php echo $__env->make('default.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\my-app-ngaymoi24h.vn\resources\views/default/pages/baiviet.blade.php ENDPATH**/ ?>